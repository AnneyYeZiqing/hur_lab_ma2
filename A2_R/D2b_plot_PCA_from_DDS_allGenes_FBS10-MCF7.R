...
dds_rds_path <- "/project_rootpath/D1_DESeq2_R/LY_FBS10-MCF7_allConds_dds.rds"

# ---- Addl parameters (edit paths as needed) ----
out_pdf        <- paste0(basepath, "PCA_vst_PC1_vs_PC2_LY-FBS10-MCF7.pdf") #syntax for concat string
out_png        <- paste0(basepath, "PCA_vst_PC1_vs_PC2_LY-FBS10-MCF7.png")
pca_coords_csv <- paste0(basepath, "PCA_vst_PC1_vs_PC2_LY-FBS10-MCF7.csv")
